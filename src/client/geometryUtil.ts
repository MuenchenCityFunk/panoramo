...
export function getDataBufferGeometry(scenarioDataWrapper: ScenarioDataWrapper, imgCenterPoints: {[sceneType: string] : Array<THREE.Vector3>}, targetGeometry: string) : GeneratedMeshWrapper {
...
export function exportPointCloudData(geometry: THREE.BufferGeometry) {
...
export function savePointCloudToFile(pointCloudData: any, filename: string = 'pointcloud.json') {
